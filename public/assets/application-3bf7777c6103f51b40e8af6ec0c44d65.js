...
if(s.preloadImages){(function(i){if($collection[i]!=null){var tempIMG=new Image(),callee=arguments.callee;tempIMG.src=addPrefix($($collection[i]).attr(s.srcAttr));tempIMG.onload=function(){$collection[i+1]&&callee(i+1);};}})(0);}
